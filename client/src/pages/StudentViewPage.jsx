      ...
      <div className="p-4">
        ...
        <div className="flex items-start justify-between mb-3">
          <div className="flex items-center space-x-3 min-w-0 flex-1">
            <div
              className={`w-12 h-12 rounded-full flex items-center justify-center text-white text-lg font-bold flex-shrink-0 overflow-hidden ${
                !instructor.avatar
          ...
          {/* Status Badge */}
          <div
            className={`flex items-center space-x-1.5 px-2.5 py-1 rounded-full ${statusStyle.bgColor} border ${statusStyle.border} flex-shrink-0 ml-2`}
          >
            <div
              className={`w-2 h-2 rounded-full ${statusStyle.color} animate-pulse`}
            ></div>
        ...
        <div className="space-y-2 mb-3">
          <div className="flex items-center text-sm text-gray-600">
            ...
            <span className="truncate">
              {currentStatus.location || "No location"}
            </span>
          </div>
          <div className="flex items-center text-sm text-gray-600">
            ...
            <div className="flex items-start justify-between">
              <div className="flex items-center space-x-3 min-w-0 flex-1">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-2">
                    <div
                      className={`inline-flex items-center space-x-1.5 px-3 py-1 rounded-full ${statusStyle.bgColor} border ${statusStyle.border}`}
                    >
                      <div
                        className={`w-2 h-2 rounded-full ${statusStyle.color} animate-pulse`}
                      ></div>
                ...
                {isProfileOpen && (
                  ...
                  >
                    <div className="flex flex-row gap-1 py-1">
                      <div className="ml-2 w-9 h-9 sm:w-10 sm:h-10 bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg flex items-center justify-center hover:shadow-md transition-shadow">
                        {user.avatar ? (
                          <img
        ...
        {!loading && (
          <div className="mb-4">
            <p className="text-sm text-gray-600">
              ...
              instructor{filteredInstructors.length !== 1 ? "s" : ""}
